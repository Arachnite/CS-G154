...
public class CreditCard {
  ...
  public void makePayment(double amount) {            // make a payment
    ...
    /**
     * Updates the credit limit of the card with a valid value
     * @param newLimit the new credit limit (non-negative)
     */
  ...
  public static void main(String[] args) {
    ...
    for (CreditCard card : wallet) {
        ...
        if (card.updateCreditLimit(1000)) {
            System.out.println("New limit = " + card.getLimit());
        } else {
            System.out.println("Invalid credit limit. Limit is unchanged. Limit = " + card.getLimit());
        }
    }

    CreditCard.printSummary(wallet[0]);
    if (wallet[0].updateCreditLimit(-1000)) {
        System.out.println("New limit = " + wallet[0].getLimit());
    } else {
        System.out.println("Invalid credit limit. Limit is unchanged. Limit = " + wallet[0].getLimit());
    }
  }
}

/*
Output of main (with updateCreditLimit method):
...
Balance = 8.0
Limit = 1000
Invalid credit limit. Limit is unchanged. Limit = 1000
*/
